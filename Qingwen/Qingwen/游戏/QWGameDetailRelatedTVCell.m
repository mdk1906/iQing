...
@interface QWGameDetailRelatedTVCell () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation QWGameDetailRelatedTVCell
...
{
    QWGameDetailRelatedCVCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //Game  根据id 暂时获取不到 采用URL
//    params[@"id"] = book.nid;
    [[QWRouter sharedInstance] routerWithUrlString:[NSString getRouterVCUrlStringFromUrlString:@"gamedetail" andParams:params]];
}
