//
//  NSObject+YumiYYModel.h
//  YumiYYModel <https://github.com/ibireme/YumiYYModel>
//
 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `YumiYYModel` protocol for custom methods.


 Sample Code:

     ********************** json convertor *********************
     @interfaceClass YumiYYAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation YumiYYAuthor
     @end

     @interfaceClass YumiYYBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) YumiYYAuthor *author;
     @end
     @implementation YumiYYBook
     @end

     int main() {
         // create model from json
         YumiYYBook *book = [YumiYYBook yy_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\":
 {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
     ...
     ********************** Coding/Copying/hash/equal *********************
     @interfaceClass YumiYYShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end

     @implementation YumiYYShadow
 ...
 */
@interface NSObject (YumiYYModel)
 ...
 */
@interface NSDictionary (YumiYYModel)
...
/**
 ...
 There's no need to add '<YumiYYModel>' to your class header.
 */
@protocol YumiYYModel <NSObject>
@optional
...
/**
 ...
 Example:
    ...
    model:
        @interfaceName YumiYYBook : NSObject
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @interfaceClass YumiYYShadow, YumiYYBorder, YumiYYAttachment;

        @interfaceClass YumiYYAttributes
        @property NSString *name;
        ...
        @implementation YumiYYAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [YumiYYShadow class],
                     @"borders" : YumiYYBorder.class,
                     @"attachments" : @"YumiYYAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @interfaceClass YumiYYCircle, YumiYYRectangle, YumiYYLine;

        @implementation YumiYYShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [YumiYYCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [YumiYYRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [YumiYYLine class];
            } else {
                return [self class];
            }
        }
